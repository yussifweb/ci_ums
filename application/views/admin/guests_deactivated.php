        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-success" href="<?php echo site_url('admin/activate_guest/' . $id); ?>" onclick="return confirm('Are you sure you want to activate this user')">Activate</a>
                        </td>
                    </tr>
                <?php
                }
